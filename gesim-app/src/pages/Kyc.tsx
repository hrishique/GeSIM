    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-6 md:p-8 space-y-6">
        <div className="text-center">
          ...
          <h2 className="text-sm mt-4 text-black font-semibold">Upload Your Passport</h2>
          <p className="text-sm text-gray-600 mt-1">
            Please upload the front and back of your passport for <br /> KYC verification.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {['front', 'back'].map((side) => {
            ...
            return (
              <label
                key={side}
                className="border border-dashed border-gray-300 rounded-xl flex flex-col items-center justify-center h-40 cursor-pointer relative overflow-hidden hover:border-indigo-400 transition"
              >
                <input
                  type="file"
                  accept="image/*"
                  onChange={(e) => handleImageChange(e, side as 'front' | 'back')}
