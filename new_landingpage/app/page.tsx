...
export default function GeSIMLanding() {
  ...
  return (
    ...
    >
        ...
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="relative w-10 h-10 p-0.5 bg-gradient-to-br from-slate-800 to-slate-900   overflow-hidden">
              <Image
                ...
                alt="GeSIM"
                fill
                className={`object-cover ${isDark ? "scale-150" : "scale-125"}`}
              />
            </div>
            <span
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button
              ...
              } px-6 py-2 rounded-xl font-medium shadow-lg hover:shadow-xl transition-all flex items-center gap-2`}
            >
        ...
        <div className="absolute inset-0">
          <div
            className={`absolute top-20 left-10 w-72 h-72 ${
              isDark ? "bg-slate-800/20" : "bg-slate-200/30"
            } rounded-full blur-3xl`}
          ></div>
          <div
            className={`absolute bottom-20 right-20 w-96 h-96 ${
              isDark ? "bg-slate-700/20" : "bg-slate-300/30"
            } rounded-full blur-3xl`}
          ></div>
        </div>
        ...
        <div className="container mx-auto relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="text-left">
              ...
              >
                ...
                <span className="relative">
                  ...
                  <div
                    ...
                    } rounded-full flex items-center justify-center text-xs font-bold text-white transform rotate-12 shadow-lg`}
                  >
              ...
              {/* Subheading */}
              <p
                className={`text-xl md:text-2xl font-medium mb-12 ${
                  isDark ? "text-slate-400" : "text-slate-600"
                ...
                <Button
                  ...
                  className={`${
                    isDark
                      ? "bg-slate-800 hover:bg-slate-700 text-white"
                      : "bg-slate-900 hover:bg-slate-800 text-white"
                  } px-12 py-4 text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 flex items-center gap-3`}
                >
            ...
            <div className="flex justify-center lg:justify-end">
              <div className="relative w-96 h-96">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative">
                    ...
                    <div
                      ...
                      } rounded-full shadow-2xl flex items-center justify-center border-4 ${
                    ...
                    {/* Pulsing Rings */}
                    <div
                      className={`absolute inset-0 w-24 h-24 border-2 ${
                        isDark ? "border-slate-600/40" : "border-slate-400/40"
                      } rounded-full animate-ping`}
                    ></div>
                    <div
                      className={`absolute -inset-2 w-28 h-28 border-2 ${
                        isDark ? "border-slate-600/30" : "border-slate-400/30"
                      } rounded-full animate-ping`}
                  ...
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-6">
                      <div
                        ...
                        } rounded-2xl p-3 shadow-xl border-2 ${
                  ...
                  <div className="relative w-full h-full">
                    ...
                    <div className="absolute left-0 top-1/2 transform -translate-x-6 -translate-y-1/2">
                      <div
                        ...
                        } rounded-xl p-2.5 shadow-xl border-2 ${
                    ...
                    <div className="absolute right-0 top-1/2 transform translate-x-6 -translate-y-1/2">
                      <div
                        className={`w-14 h-14 ${
                          isDark ? "bg-cyan-600" : "bg-cyan-700"
                        } rounded-xl p-2.5 shadow-xl border-2 ${
                ...
                <div className="absolute inset-0">
                  {/* Telecom Orbit Ring */}
                  <div
                    className={`absolute inset-8 border-2 border-dashed ${
                  ...
                  {/* Web3 Orbit Ring */}
                  <div
                    className={`absolute inset-12 border-2 border-dashed ${
                ...
                >
                  <div
                    className={`w-6 h-6 ${
                      isDark ? "bg-pink-600" : "bg-pink-700"
                    } rounded-full flex items-center justify-center shadow-lg`}
                  >
      ...
      <section
        id="partners"
        className={`py-24 px-6 ${isDark ? "bg-slate-900/30" : "bg-slate-50"}`}
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 max-w-4xl mx-auto">
            {partners.map((partner, index) => (
              <div
                ...
                } border shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105 text-center flex items-center justify-center`}
              >
                <div className="w-32 h-32 relative group-hover:scale-110 transition-transform">
                  <Image
                    ...
                    className={`object-contain ${
                      (partner.name === "Telnyx" && !isDark) ||
                      (partner.name === "eSIM Access" && isDark)
                        ? "invert"
                        : ""
                    }`}
                  />
          ...
          <div className="text-center mt-16">
            <Button
              variant="outline"
              onClick={() =>
                window.open("https://t.me/charchit_web3", "_blank")
              }
      ...
      <section
        id="features"
        className={`py-32 px-6 ${isDark ? "bg-slate-950" : "bg-white"}`}
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div
              ...
              } border hover:scale-105 transition-all duration-300 group shadow-lg hover:shadow-xl`}
            >
            ...
            >
              ...
              >
                Roam Free with Stablecoin – Local Prices, Pre/Postpaid, Full
                Control{" "}
              </p>
            </div>
          </div>
      ...
      <section
        id="app"
        className={`py-20 px-6 ${isDark ? "bg-slate-900/30" : "bg-slate-50"}`}
      >
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            ...
            Empower Global Connectivity, Local Access, and Micro-Billing
            Standardization with One Sleek Mobile App
          </p>

          <div className="relative w-72 h-96 mx-auto mb-8">
            <div
              className={`w-full h-full rounded-3xl p-4 shadow-2xl ${
                isDark
              ...
              >
                <div className="text-center">
                  ...
                  <p
                    className={`text-sm ${
                      isDark ? "text-slate-400" : "text-slate-600"
                    } mb-4 flex items-baseline justify-center gap-2`}
                  >
                  ...
                  <div
                    ...
                    } text-white px-4 py-2 rounded-full text-xs font-semibold cursor-pointer transition-all duration-200 hover:scale-105`}
                  >
              ...
              <button
                ...
                className={`w-full ${
                  isDark
                    ? "bg-slate-800 hover:bg-slate-700 text-white"
                    : "bg-slate-900 hover:bg-slate-800 text-white"
                } h-14 rounded-xl text-lg font-semibold shadow-xl hover:shadow-2xl transform  transition-all duration-300 flex items-center justify-center gap-3`}
              >
                {loading && (
      ...
      >
        <div className="container mx-auto text-center">
          ...
          <p
            className={`${
              isDark ? "text-slate-500" : "text-slate-600"
            } text-sm flex items-baseline justify-center gap-2`}
          >
            © 2025 GeSIM. Revolutionizing global connectivity with blockchain
            technology.
          </p>
        </div>
